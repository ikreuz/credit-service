    ...
    <v-card class="mt-10 shadow-smallest">
      <v-layout row wrap>
        <v-flex xs12 sm12 tag="div" v-resize="onResize">
          <!-- {{ windowSize }} -->
          <v-data-table :headers="headers" :items="txnItems" class="diana-data-table pa-3"
            loading-text="Buscando... Por favor espere" :loading="loading">
            <template v-slot:top>
              <v-toolbar flat>
                <v-toolbar-title>Historial Credito</v-toolbar-title>
...
export default {
  ...
  data: () => ({
    ...
    dialogDelete: false,
    headers: [
      { text: "Numero cuenta", align: "center", value: "Numero_Cuenta" , width: '100px'},
      { text: "Aperturas", align: "center", value: "Apertura" },
      { text: "Documento", align: "center", value: "Documento_Txt" },
      { text: "Cliente", align: "center", value: "Cliente" },
      { text: "Cobrado", align: "center", value: "Cobrado" },
      { text: "Por_Cobrar", align: "center", value: "Por_Cobrar" },
      { text: "Por_Crobrar_Txt", align: "center", value: "Por_Cobrar_Txt" },
  ...
  methods: {
    ...
    deleteItemConfirm() {
      //   this.txnItems.splice(this.editedIndex, 1);
      //   this.closeDelete();
    },
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        Object.assign(this.txnItems[this.editedIndex], this.editedItem);
      } else {
        this.txnItems.push(this.editedItem);
      }
      this.close();
    },
    onResize() {
